...
export default [
  {
    ...
    response: () => {
      return {
        ...
        links: {
          first: 'http://hdcms-php.test/api/site?page=1',
          last: 'http://hdcms-php.test/api/site?page=1',
          prev: null,
          next: null,
        },
        meta: {
          ...
          links: [
            ...
            { url: 'http://hdcms-php.test/api/site?page=1', label: '1', active: true },
            { url: null, label: '\u4e0b\u4e00\u9875 »', active: false },
          ],
          path: 'http://hdcms-php.test/api/site',
          per_page: 10,
          to: 2,
          total: 2,
        },
