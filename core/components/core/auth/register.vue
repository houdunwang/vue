      ...
      <div class="p-6 flex flex-col justify-between">
        <div>
          ...
          <div class="mt-8">
            ...
            <CoreFormInputComponent v-model="form.password" class="mt-3" type="password" placeholder="密码" />
          ...
          <CoreFormButtonComponent class="w-full primary mt-2">注册</CoreFormButtonComponent>
