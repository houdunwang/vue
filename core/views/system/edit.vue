...
<template>
  ...
  <el-tabs v-model="tabModel" class="tabs">
    <el-tab-pane label="网站信息" name="base">
      <CoreFormFieldList :model="model" :fields="systemForm.base" @submit="onSubmit" />
    </el-tab-pane>
    <el-tab-pane label="验证码" name="code">
      <CoreFormFieldList :model="model.config.code" :fields="systemForm.code" @submit="onSubmit" />
    </el-tab-pane>
    ...
    <el-tab-pane label="用户头像" name="avatar">
      <CoreFormFieldList :model="model.config.avatar" :fields="systemForm.avatar" @submit="onSubmit" />
    </el-tab-pane>
    <el-tab-pane label="文件上传" name="upload">
      <CoreFormFieldList :model="model.config.upload" :fields="systemForm.upload" @submit="onSubmit" />
    </el-tab-pane>
  </el-tabs>
</template>
