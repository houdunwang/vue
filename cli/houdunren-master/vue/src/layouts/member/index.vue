    ...
    <section class="2xl:w-page 2xl:mx-auto mt-5 flex flex-col md:flex-row md:items-start gap-5 p-2">
      <div class="md:w-[200px]">
        ...
        <div class="menu">
          <router-link
            :to="{ name: 'user.info' }"
            :class="{ active: active == 'user.info' }"
            @click="active = 'user.info'">
            资料修改
          </router-link>
          <router-link
          ...
          <router-link
            :to="{ name: 'user.duration' }"
            :class="{ active: active == 'user.duration' }"
            @click="active = 'user.duration'">
            会员周期
          </router-link>
          <router-link
            :to="{ name: 'notification.member.index' }"
            :class="{ active: active == 'notification.member.index' }"
            @click="active = 'notification.member.index'">
            站内消息
          </router-link>
          <router-link
            :to="{ name: 'user.delete' }"
            :class="{ active: active == 'user.delete' }"
            @click="active = 'user.delete'">
            注销帐号
          </router-link>
        </div>
      </div>
