...
<template>
  <main v-if="model">
    <section class="bg-white rounded-xl border shadow-sm p-5 2xl:p-10 mb-5">
      <h1 class="text-3xl opacity-90">
        {{ model.title }}
      </h1>
      <div class="mt-5 text-sm opacity-90 flex flex-col md:flex-row items-stretch gap-3 border-b pb-6">
        <HdUserAvatar :user="model.user" />
          ...
          <div class="flex flex-col md:flex-row md:items-center gap-3 justify-between">
            <div class="flex items-center gap-3">
              ...
              <div class="flex items-center gap-1">
                ...
                <Favorite type="Topic" :mid="model.id" size="small" />
              </div>
            </div>
      ...
      <section class="flex justify-center">
        <Favour type="Topic" :mid="model.id" size="large" />
      </section>
    </section>

    <CommentList type="Topic" :mid="model.id" />
  </main>
</template>
